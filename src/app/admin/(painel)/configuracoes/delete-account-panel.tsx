...
export function DeleteAccountPanel() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-start gap-3 rounded-lg border border-error-bg bg-error-bg/30 p-4 sm:flex-row sm:items-center sm:justify-between lg:flex-1 dark:border-error-solid/25 dark:bg-error-solid/10">
        <div>
        ...
        <div className="flex max-w-sm flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              autoComplete="off"
              className="rounded-md border border-gray-300 bg-white px-3 h-11 text-base text-gray-900 outline-none transition-colors duration-150 focus:border-error-solid focus:ring-2 focus:ring-error-bg placeholder:text-gray-400 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-50 dark:placeholder:text-gray-600"
            />
          </div>
